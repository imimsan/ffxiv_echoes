# CLAUDE.md — ffxiv-echoes

このファイルは Claude Code がセッション開始時に自動で読み込むプロジェクト指示書。
...
- [.claude/rules/branch-rules.md](./.claude/rules/branch-rules.md) — ブランチ運用（**main / develop の禁止事項あり**）
- [.claude/rules/git-rules.md](./.claude/rules/git-rules.md) — コミット・PR ルール
- [.claude/rules/coding-rules.md](./.claude/rules/coding-rules.md) — C# / Dalamud 規約
- [.claude/rules/security-rules.md](./.claude/rules/security-rules.md) — 機密情報・破壊的操作の制限
